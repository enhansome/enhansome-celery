...
* [Celery GitHub](https://github.com/celery/celery) ⭐ 28,869 | 🐛 728 | 🌐 Python | 📅 2026-09-08 - Celery source code.
...
* [Flower](https://github.com/mher/flower) ⭐ 7,242 | 🐛 57 | 🌐 Python | 📅 2026-09-06 - Web-based tool for managing and administering Celery clusters.
* [django-celery-beat](https://github.com/celery/django-celery-beat) ⭐ 1,952 | 🐛 154 | 🌐 Python | 📅 2026-09-07 - Running periodic tasks from Django Admin.
* [django-health-check](https://github.com/revsys/django-health-check) ⭐ 1,423 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Health check plugin for Django. Celery health checks are bundled.
...
* [celery-exporter](https://github.com/danihodovic/celery-exporter) ⭐ 561 | 🐛 46 | 🌐 Python | 📅 2026-08-31 - A Prometheus exporter for Celery.
* [celery-mixin](https://github.com/danihodovic/celery-exporter/tree/master/celery-mixin) ⭐ 561 | 🐛 46 | 🌐 Python | 📅 2026-08-31 - Monitoring mixin for Celery. A set of Grafana dashboards and Prometheus rules for Celery.
...
* [RQ](https://github.com/rq/rq) ⭐ 10,678 | 🐛 250 | 🌐 Python | 📅 2026-09-06 - Simple, lightweight, Python library for creating background jobs, and processing them.
...
* [RedBeat](https://github.com/sibson/redbeat) ⭐ 1,051 | 🐛 41 | 🌐 Python | 📅 2026-09-06 - Celery Beat Scheduler that stores the scheduled tasks and runtime metadata in Redis.
...
* [celery-director](https://github.com/ovh/celery-director) ⭐ 552 | 🐛 17 | 🌐 Python | 📅 2025-04-22 - YAML workflows for Celery tasks and WebUI to run them.
