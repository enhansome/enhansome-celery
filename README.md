...
* [Celery GitHub](https://github.com/celery/celery) ⭐ 28,799 | 🐛 803 | 🌐 Python | 📅 2026-08-18 - Celery source code.
...
* [django-celery-beat](https://github.com/celery/django-celery-beat) ⭐ 1,949 | 🐛 158 | 🌐 Python | 📅 2026-08-17 - Running periodic tasks from Django Admin.
* [django-health-check](https://github.com/revsys/django-health-check) ⭐ 1,421 | 🐛 2 | 🌐 Python | 📅 2026-08-19 - Health check plugin for Django. Celery health checks are bundled.
...
* [celery-exporter](https://github.com/danihodovic/celery-exporter) ⭐ 556 | 🐛 48 | 🌐 Python | 📅 2026-08-16 - A Prometheus exporter for Celery.
* [celery-mixin](https://github.com/danihodovic/celery-exporter/tree/master/celery-mixin) ⭐ 556 | 🐛 48 | 🌐 Python | 📅 2026-08-16 - Monitoring mixin for Celery. A set of Grafana dashboards and Prometheus rules for Celery.
...
* [Celery Insights](https://github.com/danyi1212/celery-insights) ⭐ 102 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-17 - Realtime monitoring tool for Celery clusters with a modern web UI.

## Analogues

* [RQ](https://github.com/rq/rq) ⭐ 10,668 | 🐛 252 | 🌐 Python | 📅 2026-08-17 - Simple, lightweight, Python library for creating background jobs, and processing them.
* [TaskTiger](https://github.com/closeio/tasktiger) ⭐ 1,467 | 🐛 50 | 🌐 Python | 📅 2026-08-18 - Task management using Redis.
