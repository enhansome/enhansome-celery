...
* [Celery GitHub](https://github.com/celery/celery) ⭐ 28,890 | 🐛 720 | 🌐 Python | 📅 2026-09-15 - Celery source code.
...
* [Flower](https://github.com/mher/flower) ⭐ 7,241 | 🐛 48 | 🌐 Python | 📅 2026-09-13 - Web-based tool for managing and administering Celery clusters.
* [django-celery-beat](https://github.com/celery/django-celery-beat) ⭐ 1,953 | 🐛 152 | 🌐 Python | 📅 2026-09-14 - Running periodic tasks from Django Admin.
* [django-health-check](https://github.com/revsys/django-health-check) ⭐ 1,423 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - Health check plugin for Django. Celery health checks are bundled.
