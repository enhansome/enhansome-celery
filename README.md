...
* [Celery GitHub](https://github.com/celery/celery) ⭐ 28,842 | 🐛 758 | 🌐 Python | 📅 2026-08-29 - Celery source code.
...
* [Flower](https://github.com/mher/flower) ⭐ 7,238 | 🐛 156 | 🌐 Python | 📅 2026-08-16 - Web-based tool for managing and administering Celery clusters.
* [django-celery-beat](https://github.com/celery/django-celery-beat) ⭐ 1,950 | 🐛 154 | 🌐 Python | 📅 2026-08-30 - Running periodic tasks from Django Admin.
...
* [celery-exporter](https://github.com/danihodovic/celery-exporter) ⭐ 559 | 🐛 44 | 🌐 Python | 📅 2026-08-31 - A Prometheus exporter for Celery.
* [celery-mixin](https://github.com/danihodovic/celery-exporter/tree/master/celery-mixin) ⭐ 559 | 🐛 44 | 🌐 Python | 📅 2026-08-31 - Monitoring mixin for Celery. A set of Grafana dashboards and Prometheus rules for Celery.
...
* [Celery Insights](https://github.com/danyi1212/celery-insights) ⭐ 103 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-24 - Realtime monitoring tool for Celery clusters with a modern web UI.

## Analogues

* [RQ](https://github.com/rq/rq) ⭐ 10,678 | 🐛 255 | 🌐 Python | 📅 2026-08-30 - Simple, lightweight, Python library for creating background jobs, and processing them.
