...
* [Celery GitHub](https://github.com/celery/celery) ⭐ 28,803 | 🐛 795 | 🌐 Python | 📅 2026-08-20 - Celery source code.
...
* [django-celery-beat](https://github.com/celery/django-celery-beat) ⭐ 1,949 | 🐛 155 | 🌐 Python | 📅 2026-08-20 - Running periodic tasks from Django Admin.
* [django-health-check](https://github.com/revsys/django-health-check) ⭐ 1,422 | 🐛 2 | 🌐 Python | 📅 2026-08-19 - Health check plugin for Django. Celery health checks are bundled.
...
* [celery-exporter](https://github.com/danihodovic/celery-exporter) ⭐ 556 | 🐛 49 | 🌐 Python | 📅 2026-08-16 - A Prometheus exporter for Celery.
* [celery-mixin](https://github.com/danihodovic/celery-exporter/tree/master/celery-mixin) ⭐ 556 | 🐛 49 | 🌐 Python | 📅 2026-08-16 - Monitoring mixin for Celery. A set of Grafana dashboards and Prometheus rules for Celery.
...
* [RQ](https://github.com/rq/rq) ⭐ 10,669 | 🐛 252 | 🌐 Python | 📅 2026-08-17 - Simple, lightweight, Python library for creating background jobs, and processing them.
